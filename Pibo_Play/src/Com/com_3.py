...
sys.path.append('/home/pi/Pibo_Package_05/Pibo_Play/')
    ...
    def com_3(self):
        ...
        while True:
            ...
            if answer[0][0] == "done" or answer[0][0] == "yes" or answer[0][0] == "next":
                ...
                audio.audio_play(filename="/home/pi/Pibo_Package_05/Pibo_Play/data/behavior/audio/sound_standing.mp3", volume=-1500, background=False)  
