...
from Pibo_Package_05.Pibo_Conversation.data.text_to_speech import TextToSpeech, text_to_speech
from Pibo_Package_05.Pibo_Conversation.src.drive_upload import drive_upload

# sys.path.append('/home/pi/Pibo_Package_05/Pibo_Conversation/')
from Pibo_Package_05.Pibo_Conversation.data.c_conversation_manage import ConversationManage, WordManage
from Pibo_Package_05.Pibo_Conversation.data.text_to_speech import TextToSpeech, text_to_speech
import Pibo_Package_05.Pibo_Conversation.data.behavior.behavior_list as behavior
...
class RunSchedule():
    ...
    def __init__(self):
        self.path = '/home/pi/Pibo_Package_05'
        self.completion = int
        self.act = ''
    ...
    def day(self):
        ...
        try:
            ...
            if self.completion >= 12:
                ...
                subprocess.run(['python3 /home/pi/Pibo_Package_05/Pibo_Conversation/src/start_touch.py'], shell=True)
