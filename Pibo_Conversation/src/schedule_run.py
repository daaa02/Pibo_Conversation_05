...
from Pibo_Package_05.Pibo_Conversation.data.upload_test import drive_upload
...
class RunSchedule():
    ...
    def day(self):
        ...
        # out = subprocess.check_output([f'python3 /home/pi/Pibo_Package_05/Pibo_Conversation/src/greeting.py'], shell=True, stderr=subprocess.STDOUT, encoding="utf-8")  
